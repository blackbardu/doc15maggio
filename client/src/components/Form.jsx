...
const Form = ({ pageName }) => {
  ...
  const renderParagraphs = (paragraphs) => {
    if (!Array.isArray(paragraphs)) {
      return null; // Return null if paragraphs is not an array
    }

    if (paragraphs.length === 0) {
      return <p>No content available.</p>; // Return a message if paragraphs array is empty
    }
          ...
          <div class="col">
            <div class="mb-3">
              ...
              <DropdownButton
                ...
                className="mt-2"
              >
                <Dropdown.Item eventKey="Relazione finale" href="#">
                  Relazione finale
                </Dropdown.Item>
                <Dropdown.Divider />
                <Dropdown.Item eventKey="Programma svolto" href="#">
                  Programma svolto
                </Dropdown.Item>
              </DropdownButton>
            </div>
