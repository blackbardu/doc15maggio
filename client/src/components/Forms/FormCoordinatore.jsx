          ...
          <div class="container-fluid">
                        ...
                        <div class="col">
                            <div class="mb-3">
                                ...
                                <DropdownButton
                                    ...
                                    <Dropdown.Item eventKey="Memorandum per i candidati" href="#">Memorandum per i candidati</Dropdown.Item>
                                    <Dropdown.Divider />
                                    <Dropdown.Item eventKey="Profilo professionale in uscita" href="#">Profilo professionale in uscita</Dropdown.Item>
                                    <Dropdown.Divider />
                    ...
                    <div class="row">
                        ...
                        <Accordion.Item eventKey="0">
                            <Accordion.Header><strong>Memorandum per i candidati</strong></Accordion.Header>
                            <Accordion.Body>
                            {renderParagraphs(fileContent[`memorandum.txt`])}
                            </Accordion.Body>
                        </Accordion.Item>
                        <Accordion.Item eventKey="1">
                            <Accordion.Header><strong>Profilo professionale in uscita</strong></Accordion.Header>
                            <Accordion.Body>
